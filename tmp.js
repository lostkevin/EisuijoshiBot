...
function getResult(O) {
    ...
    var E = function () {
        ...
        return {
            ...
            l: function (a, b) {
                ...
                this.g = 8;
                if (136 == b)
                    for (b = 0; 136 > b; ++b) a[b] && ++e[b >> 2];
                else if (34 == b)
                    for (b = 0; 34 > b; ++b) e[b] = a[b];
                else
                    for (--b; 0 <= b; --b) ++e[a[b] >> 2]
            },
            j: function () {
    ...
    function ea(b) {
        function a(a) {
            a &= 127;
            return 21 > a ?
                (a = 9 * Math.floor(a / 7) + a % 7, L(H(4 * a + 1)) + L(H(4 * a + 5)) + L(H(4 * a + 9)))
                : 55 > a ?
                    (a = L(H(4 * (a - 21) + 1)), a + a + a) : 89 > a ? (a = L(H(4 * (a - 55) + 1)), a + a + a + a)
                        : ""
        }
            ...
            for (b = 0; 4 > b; ++b)
                if (d.c[b].a) {
                    if (0 == b && 4294967295 == d.c[0].a) {
                        var c = c + "\u56fd\u58eb\u5f62\u548c\u4e86 ",
                            c = c + (g(d.c[b].b) + " "),
                            f, r = [0, 8, 9, 17, 18, 26, 27, 28, 29, 30, 31, 32, 33];
    ...
    function fa() {
        ...
        for (var c = false, a = "q", g = g.replace(/(\d)(\d{0,8})(\d{0,8})(\d{0,8})(\d{0,8})(\d{0,8})(\d{0,8})(\d{8})(m|p|s|z)/g, "$1$9$2$9$3$9$4$9$5$9$6$9$7$9$8$9").replace(/(\d?)(\d?)(\d?)(\d?)(\d?)(\d?)(\d)(\d)(m|p|s|z)/g, "$1$9$2$9$3$9$4$9$5$9$6$9$7$9$8$9").replace(/(m|p|s|z)(m|p|s|z)+/g, "$1").replace(/^[^\d]/, ""), g = g.substr(0, 28), f = aa(g), r = -1; r = Math.floor(136 * Math.random()), f[r];);
        length = Math.floor(g.length / 2)
        var m = length % 3;
        2 == m || (f[r] = 1, g += H(r));
        var f = ca(f),
            n = "",
            e = G(f, 34),
            n = n + N(e, 28 == g.length),
            n = n + ("(" + Math.floor(g.length /
                2) + "\u679a)"); - 1 == e[0] && (n += '\u65b0\u3057\u3044\u624b\u724c\u3092\u4f5c\u6210');
        q = e[0];
        var k, p, l = Array(35);
        if (0 >= q)
            for (k = 0; 34 > k; ++k) f[k] && (f[k]--, l[k] = K(f), f[k]++, l[k].length && (l[k] = {
                i: k,
                n: b(l[k], f),
                c: l[k]
            }));
        ...
        l[34] && l[34].n && (l[34].q = J(g), t.push(l[34]));
        t.sort(function (a, b) {
            return b.n - a.n
        });
        g = "";
        ...
        - 1 == e[0] && (d = d + ea(f));
        return (length == 13 ? "\u6478 " + fill : "\n") + d + (e[0] == -1 ? '' : ('\n' + n)) + g
    }
    var ga = 'q';
    if (O.length)
        if (null != O.match(/^(\d+m|\d+p|\d+s|[1234567]+z)*$/))
            return O + ' ' + fa();
    return O
}
